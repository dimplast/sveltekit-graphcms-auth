...
<form on:submit|preventDefault={submit} class='space-y-5 {$$props.class}'>
    ...
    <Input label="Confirm Password" id="confirm-password" name="confirm-password" type="password" required bind:value={confirmPassword} bind:inputRef={confirmPasswordInputRef}/>
    {#if error}
